    ...
    return (
        <Stack spacing={8} textAlign='left'>
            ...
            <Stack spacing={2} className='summary-project'>
                ...
                <Typography>
                    {toBeRendered({ step: 'project', part: 'goals' }) && <>{t('project.goals')}: <Typography component='span'>{formData.project.goals}</Typography><br /></>}
                    {toBeRendered({ step: 'project', part: 'investmentLocation' }) && <>{t('project.investmentLocation')}: <Typography component='span' fontWeight={700}>{formData.project.investmentLocation}</Typography><br /></>}
                    {toBeRendered({ step: 'project', part: 'tender' }) && <>{t('project.tender')}<br /></>}
                    {toBeRendered({ step: 'project', part: 'consultingCompany' }) && <>{t('project.consultingCompany')}<br /></>}
